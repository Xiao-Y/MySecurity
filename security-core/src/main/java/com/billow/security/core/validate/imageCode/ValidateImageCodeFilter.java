...
public class ValidateImageCodeFilter extends OncePerRequestFilter implements InitializingBean {
    ...
    private void validate(HttpServletRequest request) throws ServletRequestBindingException {
        ...
        if (codeInSession.isExpried()) {
            sessionStrategy.removeAttribute(servletWebRequest, CodeGenerator.SESSION_KEY_CODE_IMAGE);
    ...
    public ValidateImageCodeFilter setAuthenticationFailureHandler(AuthenticationFailureHandler authenticationFailureHandler) {
        this.authenticationFailureHandler = authenticationFailureHandler;
        return this;
    }

    public ValidateImageCodeFilter setSecurityProperties(SecurityProperties securityProperties) {
